...
import loadingRollingCircle from "../assets/animations/loading-rolling-circle.json"
import receiptPrinting from "../assets/animations/receipt-printing.json"
  ...
  return (
    <div className="flex flex-col gap-4">
      <HeadlessUiModal.Header
        header={i18n._(t`Confirm transaction`)}
        onClose={onDismiss}
      />
...
> = ({ onDismiss, chainId, hash /** , currencyToAdd **/ }) => {
  ...
  return (
    <div className="flex flex-col gap-4">
      <HeadlessUiModal.Header
        header={i18n._(t`Transaction submitted`)}
        onClose={onDismiss}
      />
      <HeadlessUiModal.BorderedContent className="flex flex-col items-center justify-center gap-1">
...
export const TransactionErrorContent: FC<TransactionErrorContentProps> = ({
  ...
  return (
    <div className="flex flex-col gap-4">
      <HeadlessUiModal.Header
        header={i18n._(t`Transaction Rejected`)}
        onClose={onDismiss}
      />
      ...
      <Button onClick={onDismiss}>{i18n._(t`Dismiss`)}</Button>
    </div>
  )
}
